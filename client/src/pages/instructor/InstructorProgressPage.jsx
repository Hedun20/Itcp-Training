...
import { CheckCircle2, GraduationCap, UsersRound, XCircle } from 'lucide-react';
  ...
  return (
    <div className="page-stack">
      <PageHeader
        ...
        description="Open a learner record to review their courses, progress, and assessment history. Data remains limited to courses you own."
      />
      ...
      {state.loading ? (
        ...
        <LearnerRecords
          ...
          emptyMessage="Activity for your courses will appear here when learners begin training."
        />
      ) : !records.length ? (
        <EmptyState
          title="No learner activity yet"
          message="Activity for your courses will appear here when learners begin training."
        />
      ) : tab === 'progress' ? (
              ...
              <TrainingCard key={record._id || record.id} className="progress-record">
                <div className="progress-record__main">
                  <div className="badge-row">
                    ...
                    <Badge>{course.code || record.courseCode}</Badge>
                  </div>
                  ...
                  <div className="course-progress">
                    <span>
                      ...
                      <strong>{Math.round(record.percentage || 0)}%</strong>
                    </span>
              ...
              {state.results.map((attempt) => {
                ...
                return (
                  <tr key={attempt._id || attempt.id}>
                    ...
                    <td><strong>{Math.round(attempt.percentage ?? 0)}%</strong></td>
